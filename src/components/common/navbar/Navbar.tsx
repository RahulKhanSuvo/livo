      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            animate={{ height: 'calc(100vh - 48px)', opacity: 1 }}
            exit={{ height: 0, opacity: 0 }}
            transition={{
              height: { duration: 0.35, ease: [0.16, 1, 0.3, 1] },
              opacity: { duration: 0.2 },
            }}
            className="fixed inset-0 top-12 bg-white z-50 lg:hidden overflow-y-auto border-t border-neutral-200"
          >
            <motion.div
                  ...
                  <div key={category.id} className="border-b border-neutral-100 pb-4">
                    <div className="flex items-center justify-between">
                      <Link
                        ...
                        className="font-semibold tracking-wider text-[13px] uppercase text-neutral-900"
                      >
                        {category.title}
                      </Link>
